...
const UpdateCustomer = () => {
    ...
    const submitUpdateCustomerHandler = () => {
        ...
        navigate(`/updatecustomer/${customerOnScreen.id}`)
    }
                            ...
                            <Row>
                                <Col md={6}>
                                    <Form.Group className="mb-3" controlId="password">
                                        <Form.Label className="labelForm">Constraseña</Form.Label>
                                        <Form.Control
                                            type="password"
                                            placeholder="Ingresar contraseña"
                                            min={1}
                                            value={customerOnScreen.password}
                                            onChange={(e) => setCustomerOnScreen({ ...customerOnScreen, password: e.target.value })}
                                        />
                                    </Form.Group>
                                </Col>
                                <Col md={6}>
                            ...
                            <Row>
                                <Col md={6}>
                                    <Form.Group className="mb-3" controlId="usuario">
                                        <Form.Label className="labelForm">Nombre de usuario</Form.Label>
                                        <Form.Control
                                            type="text"
